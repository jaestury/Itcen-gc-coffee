...
export function Summary({items = [], onOrderSubmit}) {
    ...
    const handelPostcodeInputChanged = (e) => setOrder({ ...order, postcode: e.target.value })
        ...
        <React.Fragment>
            ...
            <form>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" value={order.postcode} onChange={handelPostcodeInputChanged} id="postcode"/>
                </div>
